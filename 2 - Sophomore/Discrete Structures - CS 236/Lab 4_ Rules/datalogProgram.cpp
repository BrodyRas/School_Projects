...
vector<Predicate> datalogProgram::giveSchemes(){
  return schemes;
}

vector<Predicate> datalogProgram::giveFacts(){
  return facts;
}

vector<Predicate> datalogProgram::giveQueries(){
  return queries;
}

vector<Rule> datalogProgram::giveRules(){
  return rules;
}
