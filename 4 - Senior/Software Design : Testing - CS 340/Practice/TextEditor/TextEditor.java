...
class TextEditor {
            ...
            if (option != -1) {
                switch (option) {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        ICommand command = new Start(_document);
                        undoRedoManager.excecute(command);
                        break;
                    case 8:
    ...
    private void insert() {
        ...
        if (insertionIndex != -1) {
            ...
            ICommand command = new Insert(_document, insertionIndex, sequenceInput);
            undoRedoManager.excecute(command);
    ...
    private void delete() {
        ...
        if (deletionIndex != -1) {
            ...
            ICommand command = new Delete(_document, deletionDistance, deletionIndex);
            undoRedoManager.excecute(command);
        }
    }
    ...
    private void replace() {
        ...
        if (replaceIndex != -1) {
            ...
            if (replaceDistance != -1) {
                ...
                ICommand command = new Replace(_document,replaceIndex,replaceDistance,replacementString);
                undoRedoManager.excecute(command);
            }
        }
    }
    ...
    private void open() {
        ...
        ICommand command = new Open(_document, openFileName);
        undoRedoManager.excecute(command);
    }
